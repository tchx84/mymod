...
void idGameLocal::InitConsoleCommands( void ) {
	...
	cmdSystem->AddCommand( "clientChangeWeapon",	idMultiplayerGame::ChangeWeapon_f, CMD_FL_GAME,			"change current weapon" );
	cmdSystem->AddCommand( "clientMessageMode",		idMultiplayerGame::MessageMode_f, CMD_FL_GAME,			"ingame gui message mode" );
	cmdSystem->AddCommand( "selectWeaponsMenu",		idMultiplayerGame::SelectWeapons_f, CMD_FL_GAME, "weapons selection gui" );
	cmdSystem->AddCommand( "pickupWeapon",		idMultiplayerGame::PickupWeapon_f, CMD_FL_GAME, "Pickup Weapon" );
	// FIXME: implement
